...
BLUE_ROAD_TEMPLATE1 = cv.imread(f'{PATH}blue_road_template.jpg')
...
if __name__ == '__main__':
    ...
    city_centers = find_city_centers_wo_roi_opencv(img_gray, debug=False)
    train_centers, trains_mask = find_trains_mask(img, color='red', debug=False)
    ...
    blue_ntrains, blue_score = count_color_trains_and_score( sticked_trains_mask, debug=False )
